...
import { Building2, CheckCircle2, Eye, XCircle, Plus, Edit2, Trash2 } from "lucide-react";
    ...
    return (
        <div className="p-6 space-y-6 max-w-screen-xl mx-auto">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Team Companies</h1>
                    <p className="text-sm text-gray-400 mt-0.5">Manage and view companies across your entire team</p>
                </div>
                <button
            ...
            <Card>
                <CardHeader title="All Team Companies">
                    <input type="text" placeholder="Search company..."
                        value={search} onChange={e => setSearch(e.target.value)}
                        className="text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-purple-400 w-64" />
                </CardHeader>
