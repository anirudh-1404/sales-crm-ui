...
import { Users, Building2, Users2, ChevronDown, Plus, Edit2, Trash2 } from "lucide-react";
    ...
    return (
        <div className="p-6 space-y-6 max-w-screen-xl mx-auto">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Team Contacts</h1>
                    <p className="text-sm text-gray-400 mt-0.5">Manage and view contacts across your entire team</p>
                </div>
                <button
            ...
            <Card>
                <CardHeader title="All Team Contacts">
