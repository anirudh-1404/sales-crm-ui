        ...
        <div className="flex h-screen bg-gray-50 font-sans overflow-hidden relative">
            ...
            `}>
                ...
                <div className="px-4 py-3 border-b border-gray-50 bg-gray-50/30">
                    <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5 transition-all">
                        <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                        <span className="text-[10px] font-bold text-green-700 uppercase tracking-wider">Representative</span>
                    </div>
                </div>
                ...
                <nav className="flex-1 overflow-y-auto px-3 py-2 space-y-5">
                    <div>
                        ...
                        <div className="space-y-1">
                            <SidebarLink to="/rep/dashboard" icon={LayoutDashboard} label="My Dashboard" onClick={closeSidebarOnMobile} />
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-w-0">
                <header className="h-16 bg-white border-b border-gray-200 flex items-center px-5 gap-4 flex-shrink-0">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 flex-1 max-w-[140px] sm:max-w-xs pl-3 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-400 hover:border-green-300 hover:bg-green-50/30 transition text-left"
                    >
                        <Search size={15} />
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 sm:pl-3 sm:border-l border-gray-100">
                        <div className="relative flex-shrink-0">
                            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-br from-green-500 to-green-300 flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-sm">{initials}</div>
